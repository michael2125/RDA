...
Dataset_name = {'new_mnist_3000_784'};
...
for iDB = 1:length( Dataset_name )% DB is data base; and length(DB) is number of Data Base.
    ...
    Y = gnd;
    % =====================================================================
    type_method = 'GRDA'; % as type = 'NTD_LE' & options.alpha = 0, that is NTD algorithm
    tensor_shape    = [28 28];% the dimension for dataset dependent reshaped tensors
    lowerdims = [10 10];
    % =====================================================================
